                ...
                {availableEvents.length > 0 ? (
                  <>
                    ...
                    <div className="flex items-start space-x-2">
                      ...
                      <div>
                        <p className="text-blue-200 font-medium">ทำตามเหตุการณ์</p>
                  ...
                  <div className="flex items-start space-x-2">
                    <span className="text-yellow-400 mt-1">1️⃣</span>
                    <div>
                      <p className="text-blue-200 font-medium">กลับไปหน้าสถานที่</p>
                      <p className="text-blue-300 text-sm">ไปที่สถานที่อื่นๆ เพื่อค้นหาเหตุการณ์ใหม่ๆ ที่จะเปิดให้เล่น</p>
                    </div>
                  </div>
                )}
              </div>
