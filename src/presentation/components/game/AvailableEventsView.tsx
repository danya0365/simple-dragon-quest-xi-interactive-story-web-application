...
export function AvailableEventsView() {
  ...
  }, [userGameState?.id, loadAvailableEventsForUserProgress]);
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-blue-200 text-lg">กำลังโหลดเหตุการณ์ทั้งหมด...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="text-center">
          <h2 className="text-2xl font-bold text-yellow-400 font-serif">
            ⚡ เหตุการณ์ทั้งหมด (โหมดโกงเกม)
          </h2>
          <p className="text-blue-200">
            เหตุการณ์ทั้งหมดที่คุณสามารถเล่นได้ในตอนนี้
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {availableEvents.map((event) => (
          <div
            ...
            className="bg-white/10 backdrop-blur-md rounded-lg border border-white/20 p-6 cursor-pointer transition-all duration-300 transform hover:scale-105 hover:bg-white/20 hover:border-yellow-400/50 relative overflow-hidden"
          >
            {/* Event Type Badge */}
      ...
      {availableEvents.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-blue-300 mb-4">
            ลองเริ่มเกมใหม่หรือทำภารกิจเพื่อปลดล็อคเหตุการณ์
          </p>
          <button
            onClick={handleBackToWorldMap}
        ...
        <div className="flex items-start space-x-4">
          ...
          <div className="flex-1">
              ...
              {availableEvents.length > 0 ? (
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    ...
                    <p className="text-blue-300 text-sm">
                      ไปที่สถานที่ต่างๆ เพื่อเริ่มเกมและปลดล็อคเหตุการณ์
                    </p>
                  </div>
                </div>
              )}
            ...
            <div className="mt-4 pt-4 border-t border-yellow-500/30">
              <div className="flex items-center text-blue-300 text-sm">
                <span className="mr-2">⚡</span>
                <span>โหมด: เหตุการณ์ทั้งหมด (โกงเกม)</span>
              </div>
              <span className="text-yellow-400 font-medium">
                {availableEvents.length > 0
                  ? `มี ${availableEvents.length} เหตุการณ์ที่พร้อมเล่น`
                  : "ยังไม่มีเหตุการณ์ที่พร้อมเล่น"}
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="bg-blue-900/30 rounded-lg border border-blue-500/30 p-4 mt-6">
        ...
        <ul className="text-blue-200 text-sm space-y-1">
          <li>• โหมดนี้แสดงเหตุการณ์ทั้งหมดที่คุณสามารถเล่นได้</li>
          <li>• คุณสามารถเล่นเหตุการณ์ใดๆ ก็ได้ไม่ว่าจะอยู่ที่ไหน</li>
          <li>• เหมาะสำหรับการทดสอบหรือสำรวจเนื้อเรื่องทั้งหมด</li>
          <li>• การเลือกตัวเลือกจะส่งผลต่อเนื้อเรื่องในอนาคตเหมือนปกติ</li>
        </ul>
      </div>
    </div>
  );
