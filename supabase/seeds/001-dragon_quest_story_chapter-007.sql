...
CROSS JOIN (
  VALUES 
    ...
    ('88888888-8888-8888-8888-888888888072', 'Face Pearl Guardian', 'fight', 'reward', 'Victory in Battle', 'Luminary เอาชนะผู้พิทักษ์ไข่มุกด้วยความกล้าหาญ!', '{"experience": 250, "items": [{"id": "55555555-5555-5555-5555-555555555024", "quantity": 1}], "party_joins": ["44444444-4444-4444-4444-444444444020"], "unlock_regions": ["11111111-1111-1111-1111-111111111008"]}', null),
    ('88888888-8888-8888-8888-888888888073', 'Face Pearl Guardian', 'negotiate', 'story', 'Peaceful Resolution', 'ผู้พิทักษ์ประทับใจในปัญญาของ Luminary และยอมให้ผ่าน', '{"experience": 200, "items": [{"id": "55555555-5555-5555-5555-555555555024", "quantity": 1}], "party_joins": ["44444444-4444-4444-4444-444444444020"], "unlock_regions": ["11111111-1111-1111-1111-111111111008"]}', null)
