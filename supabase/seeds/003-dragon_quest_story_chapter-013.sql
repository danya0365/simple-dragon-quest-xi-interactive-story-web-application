...
FROM (
  VALUES 
    ('33333333-3333-3333-3333-333333333013', 13, 'The Wedding Bells', 'การแต่งงานของ Luminary และ Gemma และการสร้าง Cobblestone ใหม่ให้สวยงามกว่าเดิม', '{"completed_chapters": ["33333333-3333-3333-3333-333333333012"], "game_flags": {"calasmos_defeated": true}}', 13, false, '11111111-1111-1111-1111-111111111005')
...
CROSS JOIN (
  VALUES 
    ...
    ('88888888-8888-8888-8888-888888888133', 'Gemma''s Vows', 'default', 'story', 'Gemma''s Love', 'Gemma ตอบรับด้วยน้ำตาแห่งความสุข "ฉันยอมรับ!" ความรักที่แท้จริงได้รับการยืนยัน', '{"experience": 500, "items": [{"id": "55555555-5555-5555-5555-555555555042", "quantity": 1}], "relationship": {"gemma": 100}}', 'New Life Begins'),
