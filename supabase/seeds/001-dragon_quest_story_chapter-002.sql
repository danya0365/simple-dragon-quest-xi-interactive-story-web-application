...
FROM (
  VALUES 
    ('33333333-3333-3333-3333-333333333002', 2, 'The Fall from Grace', 'การเดินทางไปยัง Heliodor และการถูกกล่าวหาว่าเป็น Darkspawn', '{"completed_chapters": ["33333333-3333-3333-3333-333333333001"]}', 2, false)
