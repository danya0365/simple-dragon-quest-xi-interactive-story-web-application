...
FROM (
  VALUES 
    ('33333333-3333-3333-3333-333333333012', 12, 'The True Enemy', 'การเปิดเผยว่า Calasmos คือศัตรูตัวจริงที่อยู่เบื้องหลัง Mordegon และการต่อสู้ครั้งสุดท้ายที่แท้จริง', '{"completed_chapters": ["33333333-3333-3333-3333-333333333011"]}', 12, false, '11111111-1111-1111-1111-111111111004')
