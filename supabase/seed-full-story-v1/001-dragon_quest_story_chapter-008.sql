...
CROSS JOIN (
  VALUES 
    ('88888888-8888-8888-8888-888888888080', 'Confront Ice Queen', 'fight', 'reward', 'Ice Queen Defeated', 'Luminary เอาชนะราชินีแห่งน้ำแข็ง! ความหนาวเหน็บเริ่มลดลง', '{"experience": 300, "items": [{"id": "55555555-5555-5555-5555-555555555026", "quantity": 1}], "party_join": "44444444-4444-4444-4444-444444444022"}', 'The Crystal Heart'),
    ('88888888-8888-8888-8888-888888888081', 'Confront Ice Queen', 'reason', 'story', 'Peaceful Resolution', 'ราชินีแห่งน้ำแข็งเข้าใจและยอมช่วยเหลือ Luminary', '{"experience": 250, "items": [{"id": "55555555-5555-5555-5555-555555555027", "quantity": 1}], "party_join": "44444444-4444-4444-4444-444444444022"}', 'The Crystal Heart'),
