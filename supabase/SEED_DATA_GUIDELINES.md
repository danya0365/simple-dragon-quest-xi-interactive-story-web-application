...
INSERT INTO event_outcomes (interaction_id, choice_id, ...) VALUES
...
```sql
-- ต้องใช้ choice_id ตรงกับ choices ใน interaction
choice_id: 'choice1'  -- ตรงกับ id ใน choices array
...
INSERT INTO event_outcomes (interaction_id, choice_id, outcome_type, title, description, effects, next_event_id)
...
```sql
-- สาเหตุ: choice_id ใน outcomes ไม่ตรงกับ id ใน choices
-- แก้ไข: ตรวจสอบให้ choice_id ตรงกัน
SELECT ei.choices, eo.choice_id 
